...
public class SabadellBankTypesFactory implements IBanksTypesFactory {
	...
	/**
	 * Se crea la cabeceara partir del registro
	 */
	...
	/**
	 * Se crea el pie a partir del registro recibido
	 */
	...
	public Registro<List<IRegistroPrincipal>, IRegistroInformacionEquivalencia, IRegistroFinalCuenta> createRegistro43(
			List<IRegistroPrincipal> lrPrincipal, IRegistroInformacionEquivalencia rie,
			IRegistroFinalCuenta rfc) {

		Registro<List<IRegistroPrincipal>, IRegistroInformacionEquivalencia, IRegistroFinalCuenta> registro = new Registro<List<IRegistroPrincipal>, IRegistroInformacionEquivalencia, IRegistroFinalCuenta>();
