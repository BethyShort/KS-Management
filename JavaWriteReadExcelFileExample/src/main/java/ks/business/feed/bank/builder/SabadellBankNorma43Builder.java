...
import ks.factories.data.feed.banks.SabadellBankTypesFactory;
...
public class SabadellBankNorma43Builder {

	private SabadellBankTypesFactory factory = new SabadellBankTypesFactory();
	private static SabadellBankNorma43Builder instance = null;
	 ...
	 * @param value
	 */
	private SabadellBankNorma43Builder(List<String> value) {
		init(value);
	}
	 ...
	 * @param value
	 */
	private SabadellBankNorma43Builder() {
	...
	public static SabadellBankNorma43Builder getInstance(List<String> value) {
		if (instance == null)
			return new SabadellBankNorma43Builder(value);
		else
			return instance;
